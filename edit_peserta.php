...
<body>
	 ...
	 <div class="container-fluid">
        ...
        <?php $res_data = mysqli_query($koneksi,"SELECT * FROM peserta WHERE id='$id'"); ?>
        <?php $res_data = mysqli_fetch_assoc($res_data); ?>
                    ...
                    <div class="card-body">
                        <form id="data_peserta" action="javascript:;" method="post">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="name" name="name" value="<?php echo $res_data['name']; ?>" placeholder="nama">
                            </div>

                            <div class="form-group">
                                <label for="nomor_telpon">Nomor Telpon</label>
                                <input type="text" class="form-control" id="nomor_telpon" name="nomor_telpon" value="<?php echo $res_data['nomor_telpon']; ?>" placeholder="Nomor Telpon">
                            </div>

                            <div class="form-group">
                                <label for="email">email</label>
                                <input type="text" class="form-control" id="email" name="email" value="<?php echo $res_data['email']; ?>" placeholder="email">
                            </div>

                            <div class="form-group">
                                <label for="alamat">Alamat</label>
                                <input type="text" class="form-control" id="alamat" name="alamat" value="<?php echo $res_data['alamat']; ?>" placeholder="alamat">
                            </div>
                            <div class="form-group">
                                <input type="hidden" id="id" name="id" value="<?php echo $res_data['id']; ?>">
            ...
            var handleFormSubmit = function () {
                ...
                $("#data_peserta").submit(function (e) {
                    ...
                    if ($(this).valid()) {
                        $.ajax({
                            type: "post",
                            url: "<?php echo URL."edit_peserta_prosess.php"; ?>",
                            data: formData,
                            processData: false,
                            contentType: false,
